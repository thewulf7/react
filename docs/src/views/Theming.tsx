...
export default () => (
  <DocPage title="Theming">
    ...
    <p>
      ...
      understand and align your overrides to the component's internal style implementation. You also
      must ensure you properly override styles for every props permutation for that component, which
    ...
    <CodeSnippet label="js" value={`const style = { color: 'green' }`} />
